...
export function acquireRobot(
  ...
  if ((ioLevel === 0 && lowerCost) || (ioLevel > 0 && lowerCost && player.megacredits < 2)) {
    return false;
  }
 ...
 * @returns
 */
export function deployRobotToMoon(
  G: GalileoProjectGameState,
  player: Player,
  moon: Moon,
 ...
 * @returns
 */
export function assignTypeToRobot(
  G: GalileoProjectGameState,
  player: Player,
  type: RobotType,
 ...
 * @returns
 */
export function assignMoonToRobot(
  G: GalileoProjectGameState,
  player: Player,
  robotSelection: RobotSelection | null,
  moonMarker: Moon,
 ...
 * @returns
 */
export function buyEnergyThenMove(
  G: GalileoProjectGameState,
  player: Player,
  ...
  return moveRobotToMoon(
    player,
    robot,
    robotSelection!.moon === robot.moon1 ? robot.moon2! : robot.moon1,
  );
}
